	...
	*/
		...
		if((vid == 11368) /*&& (pid == 58933)*/){
			...
			case 2:
				...
				break;
			case 3:
				update_FW(path); ///home/emright/Documents/Chrome116_HP_V0001_ASIC8_20190813_52D9.BIN /*path*/
...
int get_Ckecksum(void) 
{
	...
	wDumpStartPos = g_dwDownloadStart + 0x1000;
        //printf("%d,%d",m_lnDownloadSize,nIspDataByte);
	/*t2 = time(NULL);
	printf("%ld",t2-t1);*/
